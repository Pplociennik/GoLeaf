...
class Habits extends Component {
  ...
  render() {
    ...
    habitCards.forEach(habit => {
      foundHabits = true;
      habits.push(<HabitCard key={habit.id} id={habit.id} title={habit.title} category={habit.category} frequency={habit.frequency} startedOn={habit.startDate} private={habit.private} login={habit.creatorLogin} membersNumber={habit.membersCount} habitCardClicked={this.handleHabitCardClicked} status={this.props.status} />)
