...
class AddPost extends Component {
  ...
  handleAddPost = e => {
      e.preventDefault();   
      axios.post('http://95.108.36.173:8081/api/posts/addpost', {
  ...
  componentDidMount() {
    axios.get(`http://95.108.36.173:8081/api/members/member/points?habitsID=${this.props.habitID}&userID=${this.props.user}`)
    .then(res => {
