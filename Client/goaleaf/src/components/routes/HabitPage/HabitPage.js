...
class HabitPage extends Component {
    ...
    joinHabit = id => {
        axios.post('http://localhost:8081/api/habits/habit/join', {
            "habitID": id,
    ...
    leaveHabit = id => {
        ...
        axios.delete('http://localhost:8081/api/habits/removemember', {
            data: {
                "habitID": id,
                "token": localStorage.getItem("token"),
                "userID": this.props.userLogged
    ...
    checkIfUserBanned = id => {
        axios.get(`http://localhost:8081/api/habits/ban/check?userID=${this.props.userLogged}&habitID=${id}`)
        .then(res => {
            this.setState({
                userBanned: res.data
            })
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:8081/api/habits/habit/checkPermissions?userID=${this.props.userLogged}&habitID=${parseInt(this.props.match.params.id)}`)
           .then(res => {
                    this.setState({
        ...
        axios.get(`http://localhost:8081/api/habits/habit/members?habitID=${this.props.match.params.id}`)
            .then(res => {
                    this.setState({
                          members: res.data,
                          joinLoading: false
