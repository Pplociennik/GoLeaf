  ...
  render() {
    return (
      <div className="help-page">
        <h1 className="help-header">Welcome to Goaleaf, where you can challenge your family and friends into breaking those bad habits <span role="img" aria-label="icon">🌿</span></h1>
        <section className="help-step">
          <h2 className="help-step-header">Create new Challenge <span role="img" aria-label="icon">🎯</span></h2>
        ...
        <section className="help-step">
          <h2 className="help-step-header">Invite your friends <span role="img" aria-label="icon">👨‍👩‍👧‍👦</span></h2>
          <img className="help-step-gif" src={InviteUserGif} alt="app step"></img>
        </section>
        <section className="help-step">
          <h2 className="help-step-header">Set the Goal <span role="img" aria-label="icon">🥇</span></h2>
        ...
        <section className="help-step">
          <h2 className="help-step-header">Create new Task <span role="img" aria-label="icon">🔥</span></h2>
        ...
        <section className="help-step" style={{marginBottom: "40px"}}>
          <h2 className="help-step-header">Check your position in the Leaderboard <span role="img" aria-label="icon">🏆</span></h2>
