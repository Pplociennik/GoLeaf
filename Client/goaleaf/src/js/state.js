...
export function fetchUsers() {
  return dispatch => axios.get(`http://localhost:8080/api/users/all`)
      .then(res => {
...
export function fetchHabits(pageNr, objectsNr, category, sorting){
  return dispatch => axios.get(`http://localhost:8080/api/habits/all/paging?pageNr=${pageNr}&objectsNr=${objectsNr}&category=${category}&sorting=${sorting}`)
  //return dispatch => axios.get(`http://localhost:8080/api/habits/all/`)
    .then(res => {
...
export function fetchFinishedHabits(page, toShow, token){
  return dispatch => axios.get(`http://localhost:8080/api/users/finished/paging?pageNr=${page}&objectsNr=${toShow}&token=${token}`)
    .then(res => {
...
export function fetchUnfinishedHabits(page, toShow, token){
  return dispatch => axios.get(`http://localhost:8080/api/users/unfinished/paging?pageNr=${page}&objectsNr=${toShow}&token=${token}`)
    .then(res => {
...
export function fetchWonHabits(page, toShow, token){
  return dispatch => axios.get(`http://localhost:8080/api/users/won/paging?pageNr=${page}&objectsNr=${toShow}&token=${token}`)
    .then(res => {
...
export function fetchMembers(){
  return dispatch => axios.get(`http://localhost:8080/api/members/all`)
    .then(res => {
...
export function fetchHabit(habitID){
  return dispatch => axios.get(`http://localhost:8080/api/habits/getHabit/{id}?id=${habitID}`)
    .then(res => {
...
export function fetchPosts(habitID, pageNr, objectsNr, type){
  return dispatch =>  axios.get(`http://localhost:8080/api/posts/type/paging?pageNr=${pageNr}&objectsNr=${objectsNr}&habitID=${habitID}&type=${type}`)
    .then(res => {
      if(type === "Task"){
